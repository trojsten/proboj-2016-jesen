...
const double AGRESIVITA = 5000;
const double ODSEBA = 0;
const double KAMEN = 1000;
const double SPEED = -1000;
const double NAVNADA = 4000;
const double NUM_NAVNAD = 10;
const double MIN_DIST = 2;
const double MAX_DIST = 5;
const double NEPRECHODNE = -1000;
...
int main() {
 ...
 //   cerr << ja << endl;
    ...
    while (true) {
		...
		for(auto p : gs.players){
			if( V[p.position.x][p.position.y] >= 0 && V[p.position.x][p.position.y] < currentLength*3){
